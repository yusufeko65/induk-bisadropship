<?php
    ...
    echo "<div class='col-md-6'>
        ...
        $feedlist = new rss('https://bisadropship.com'); /* Ubah link feed disini dengan link feed Anda */
        echo $feedlist->display(5,"Bisadropship"); /* Angka 7 digunakan untuk menampilkan jumlah artikel */
    echo "</section>";