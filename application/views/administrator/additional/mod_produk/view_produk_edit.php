    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Brand</th>                   <td><select name='br' class='form-control' required>
                                                                            <option value='' selected>- Pilih Brand Produk -</option>";
                                                                            foreach ($brands as $row){
                                                                              if ($rows['id_brand_produk']==$row['id_brand_produk']){
                                                                                echo "<option value='$row[id_brand_produk]' selected>$row[nama_brand]</option>";
                                                                              }else{
                                                                                echo "<option value='$row[id_brand_produk]'>$row[nama_brand]</option>";
                                                                              }
                                                                            }
                    echo "</select></td></tr>
