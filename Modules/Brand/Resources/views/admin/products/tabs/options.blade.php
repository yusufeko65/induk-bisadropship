    ...
    <div class="form-group pull-left">
        <div class="col-md-10">
            <button type="button" class="btn btn-default m-r-10" id="add-new-option">
                {{ trans('brand::options.form.add_new_option') }}
            </button>
        </div>
    </div>
            ...
            <div class="add-global-option clearfix pull-right">
                <div class="form-group pull-left">
                    <select class="form-control custom-select-black" id="global-option">
                        <option value="">{{ trans('brand::options.select_global_option') }}</option>
                ...
                <button type="button" class="btn btn-default" id="add-global-option" data-loading>
                    {{ trans('brand::options.form.add_global_option') }}
                </button>
            </div>
        @endif
    @endHasAccess
...
@include('brand::admin.options.templates.product_option')
