            ...
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#option-<%- optionId %>" href="#custom-collapse-<%- optionId %>">
                        ...
                        <span id="option-name" class="pull-left">{{ trans('brand::options.form.new_option') }}</span>
                    </a>
                </h4>
            </div>
                    ...
                    <div class="new-option clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 p-l-0">
                            <div class="form-group">
                                <label for="option-<%- optionId %>-name">{{ trans('brand::attributes.name') }}</label>
                        ...
                        <div class="col-lg-3 col-md-12 p-l-0">
                            <div class="form-group">
                                <label for="option-<%- optionId %>-type">{{ trans('brand::attributes.type') }}</label>
                                ...
                                <select name="options[<%- optionId %>][type]" class="form-control custom-select-black" id="option-<%- optionId %>-type">
                                    ...
                                    >
                                        {{ trans('brand::options.form.option_types.please_select') }}
                                    </option>

                                    <option value="dropdown"
                                        <%= option.type === 'dropdown' ? 'selected' : '' %>
                                    >
                                        {{ trans('brand::options.form.option_types.dropdown') }}
                                    </option>

                                    <option value="checkbox"
                                        <%= option.type === 'checkbox' ? 'selected' : '' %>
                                    >
                                        {{ trans('brand::options.form.option_types.checkbox') }}
                                    </option>

                                    <option value="radio"
                                        <%= option.type === 'radio' ? 'selected' : '' %>
                                    >
                                        {{ trans('brand::options.form.option_types.radio') }}
                                    </option>

                                    <option value="multiple_select"
                                        <%= option.type === 'multiple_select' ? 'selected' : '' %>
                                    >
                                        {{ trans('brand::options.form.option_types.multiple_select') }}
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="checkbox">
                            ...
                            <label for="option-<%- optionId %>-is-required">{{ trans('brand::attributes.is_required') }}</label>
                        </div>
...
@include('brand::admin.options.templates.option.select')
@include('brand::admin.options.templates.option.select_values')
